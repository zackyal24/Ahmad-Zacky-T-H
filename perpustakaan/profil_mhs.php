                    ...
                    <div class="container">
                        <div class="card profile-card">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text" id="two"><i class="fa fa-pencil fa-sm fa-fw mr-2 text-gray-400"></i><?= $npm?></p>
                                <a href="edit-password-mhs.php?n_id=<?php echo $npm; ?>" class="btn btn-primary">Ubah Password</a>
                            </div>
                        </div>
                    </div>
            <!-- /.container-fluid -->
