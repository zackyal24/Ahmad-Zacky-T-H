        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="d-none d-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
                    <div class="mb-0 text-gray-800 font-weight-bold">Dashboard | <span class="text-primary font-weight-bold">Transaksi | </span><span class="text-primary font-weight-bold">Pengembalian</span></div>
                </div>
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-3 text-gray-800">Pengembalian</h1>

                    <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">Pengembalian Buku</h6>                    
                    </div>
                    <div class="card-body">
