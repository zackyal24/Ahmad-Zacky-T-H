        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h-2 mb-4 text-center text-gray-800">Daftar Buku perpustakaan</h1>
                                ...
                                <?php
                                        ...
                                        if ($result) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td>                                                        
                                                        <a href='detail_buku_mhs.php?isbn=" . $row['isbn'] . "' class='btn btn-sm bg-primary text-white my-1 my-lg-0'><i class='fa fa-info-circle' aria-hidden='true'></i></a>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                        } else {
