...
// Query untuk mengambil informasi kategori dari database berdasarkan id_kategori
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Query untuk memperbarui informasi kategori di database
    $update_query = "UPDATE kategori SET nama_kategori = '$nama_kategori_baru' WHERE id_kategori = $id_kategori";
...
<head>
    ...
    <title>Perpustakaan - Edit Kategori</title>
    <style>
        .profile-card {
            margin: 50px auto;
            max-width: 400px;
