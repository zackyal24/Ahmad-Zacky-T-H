...
<head>
    ...
    <title>Perpustakaan - Tambah Denda</title>
                    ...
                    <div class="container mt-5">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-primary">Tambah Denda Mahasiswa</h3>
                            </div>
                            <div class="card-body">
            <form action="proses_tambah_denda.php" method="POST">
                <div class="form-group">
                    <label for="no_pinjam">Nomer Peminjaman</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="harga_denda" name="harga_denda" required>
                </div>
                <div class="form-group">
                ...
                <a href="denda.html" class="btn btn-secondary" name="edit">Batal</a>
            </form>
        </div>
                        </div>
                    </div>
